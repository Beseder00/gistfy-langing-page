  ...
  const toggleView = () => {
    ...
    if (!showAfter) {
      ...
      setTimeout(() => {
        ...
        setShowCardFormation(true)
        setCardStage(1)

        // Progress through card formation stages
        let stage = 1
        const interval = setInterval(() => {
          ...
          if (stage >= 5) {
            ...
            // Keep the card formation visible as the final state
      ...
      <div className="relative h-[650px] md:h-[750px] rounded-xl overflow-hidden shadow-2xl border border-[#E2E8F0]">
          ...
          <div className="absolute inset-0 z-30 bg-[#0F172A]/90 flex flex-col items-center pt-6 px-4 pb-4">
            ...
            <div className="w-full bg-[#4338CA] text-white p-3 sm:p-4 mb-4 sm:mb-6 flex flex-col md:flex-row justify-between items-center rounded-xl shadow-[0_0_15px_rgba(67,56,202,0.3)]">
              ...
              <Button
                ...
                className={`bg-white text-[#4338CA] hover:bg-slate-100 px-4 sm:px-5 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm whitespace-nowrap ${cardStage >= 5 ? "opacity-100" : "opacity-0"} transition-opacity duration-500`}
              >
                <span>See Without Gistify</span>
                <ArrowLeftRight className="ml-1 sm:ml-2 h-3 w-3 sm:h-4 sm:w-4 inline-block" />
              </Button>
            </div>
        ...
        >
          <div className="p-3 sm:p-5 h-full flex flex-col">
                  ...
                  return (
                    <div key={i} className="p-2 sm:p-3 border-b border-[#E2E8F0] flex items-center">
                      <div className="w-6 h-6 rounded-full overflow-hidden mr-3 flex-shrink-0 bg-[#0F172A]">
                        <Image
                          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Chamath%20Palihapitiya%20%281%29-FBvjpWt3AJ4shBcypc2GuyWPdAIsWH.png"
                          alt="Superhuman Logo"
                          width={24}
                          height={24}
                          className="w-full h-full object-cover"
            ...
            {/* Enhanced footer overlay for "before" view */}
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-r from-[#0F172A] to-[#1E293B] border-t-4 border-[#3B82F6] shadow-[0_-4px_10px_-1px_rgba(0,0,0,0.2)]">
              <div className="p-6 flex items-center justify-center">
                <Button
                  ...
                  className={`
                    ...
                    bg-white text-[#4338CA] hover:bg-slate-100
                    px-8 py-3 rounded-full shadow-xl hover:shadow-2xl font-medium text-lg border-2 border-white/20
                  `}
                >
                  {/* Background sparkle effect */}
                  <span className="absolute inset-0 w-full h-full">
                    <span
                      className="absolute top-1/4 left-1/4 w-2 h-2 bg-[#4338CA] rounded-full opacity-50 animate-ping"
                      style={{ animationDuration: "3s", animationDelay: "0.2s" }}
                    ></span>
                    <span
                      className="absolute top-3/4 left-2/3 w-1.5 h-1.5 bg-[#4338CA] rounded-full opacity-50 animate-ping"
                  ...
                  />
                  <span className="relative z-10">See With Gistify</span>
        ...
        <div
          className={`absolute inset-0 bg-white transition-opacity duration-800 opacity-0`}
          style={{
            transitionProperty: "opacity",
            transitionDuration: "800ms",
            zIndex: 1, // Always keep this behind
          }}
        >
          <div className="p-3 sm:p-5 h-full flex flex-col">
            <div className="bg-gradient-to-r from-[#EBF4FF] to-[#F3E8FF] border-b-2 border-[#6366F1] mb-4 p-4 pt-6 sm:pt-8 rounded-t-2xl shadow-[0_0_15px_rgba(99,102,241,0.2)]">
              <div className="flex items-center">
                <CheckCircle className="h-5 w-5 text-[#6366F1] mr-2" />
                <span className="font-bold text-[#6366F1]">WITH GISTIFY</span>
              </div>
            </div>

            {/* REAL RESULTS metrics at the top */}
            <div className="bg-[#0F172A]/90 backdrop-blur-sm p-3 sm:p-4 mb-3 sm:mb-4 rounded-lg">
              <div className="text-center text-white">
                <h4 className="font-bold text-lg sm:text-xl mb-2 sm:mb-4 text-[#60A5FA] tracking-wide">REAL RESULTS</h4>
                <div className="flex flex-col md:flex-row justify-center items-center gap-2 md:gap-0">
                  <div className="flex flex-col items-center">
                    <div className="text-2xl sm:text-3xl font-bold text-[#10B981]">30+</div>
                    <div className="text-xs sm:text-sm text-white/90">Newsletters</div>
                  </div>
                  ...
                  <div className="hidden md:flex items-center mx-4">
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className="text-[#60A5FA] animate-pulse"
                    >
                      <path
                        d="M39.0607 13.0607C39.6464 12.4749 39.6464 11.5251 39.0607 10.9393L29.5147 1.3934C28.9289 0.807611 27.9792 0.807611 27.3934 1.3934C26.8076 1.97919 26.8076 2.92893 27.3934 3.51472L35.8787 12L27.3934 20.4853C26.8076 21.0711 26.8076 22.0208 27.3934 22.6066C27.9792 23.1924 28.9289 23.1924 29.5147 22.6066L39.0607 13.0607Z"
                        fill="currentColor"
                      />
                    </svg>
                  </div>
                  ...
                  <div className="flex flex-col items-center">
                    <div className="text-2xl sm:text-3xl font-bold text-[#10B981]">85%</div>
                    <div className="text-xs sm:text-sm text-white/90">Less Noise</div>
                  </div>
                  ...
                  <div className="flex flex-col items-center">
                    <div className="text-2xl sm:text-3xl font-bold text-[#10B981]">{hoursSaved}</div>
                    <div className="text-xs sm:text-sm text-white/90">Hours Saved Daily</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#F1F5F9] p-3 rounded-lg border-b border-[#E2E8F0] flex items-center">
              ...
              <div className="ml-4 text-sm text-[#64748B] font-medium">Top 3 Articles Curated For You</div>
            </div>

            <div className="flex-1 overflow-y-auto bg-white">
              {/* First curated article */}
              <div className="p-3 sm:p-4 border-b border-[#E2E8F0] flex items-center">
                ...
                <div className="flex-1">
                  <div className="flex justify-between">
                    <span className="font-medium text-sm truncate max-w-[160px] sm:max-w-full">{cards[0].title}</span>
                    <div className="flex items-center">
                      <span className="text-xs text-[#64748B] mr-2 hidden sm:inline">{cards[0].source}</span>
                      <span className="text-xs text-[#64748B]">{cards[0].time}</span>
                    </div>
                  </div>
                  <div className="text-xs text-[#64748B] truncate max-w-[200px] sm:max-w-full">
                    {cards[0].points[0]}
                  </div>
                </div>
              </div>

              {/* Second curated article */}
              <div className="p-3 sm:p-4 border-b border-[#E2E8F0] flex items-center">
                <div className="w-10 h-10 rounded-lg overflow-hidden mr-4 flex-shrink-0">
                  <Image
                    src={cards[1].logo || "/placeholder.svg"}
                ...
                <div className="flex-1">
                  <div className="flex justify-between">
                    <span className="font-medium text-sm truncate max-w-[160px] sm:max-w-full">{cards[1].title}</span>
                    <div className="flex items-center">
                      <span className="text-xs text-[#64748B] mr-2 hidden sm:inline">{cards[1].source}</span>
                      <span className="text-xs text-[#64748B]">{cards[1].time}</span>
                    </div>
                  </div>
                  <div className="text-xs text-[#64748B] truncate max-w-[200px] sm:max-w-full">
                    {cards[1].points[0]}
              ...
              <div className="p-3 sm:p-4 border-b border-[#E2E8F0] flex items-center">
                ...
                <div className="flex-1">
                  <div className="flex justify-between">
                    <span className="font-medium text-sm truncate max-w-[160px] sm:max-w-full">{cards[2].title}</span>
                    <div className="flex items-center">
                      <span className="text-xs text-[#64748B] mr-2 hidden sm:inline">{cards[2].source}</span>
                      <span className="text-xs text-[#64748B]">{cards[2].time}</span>
                    </div>
                  </div>
                  <div className="text-xs text-[#64748B] truncate max-w-[200px] sm:max-w-full">
                    {cards[2].points[0]}
