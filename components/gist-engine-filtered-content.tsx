...
export function GistEngineFilteredContent() {
        ...
        <div className="max-w-5xl mx-auto">
              ...
              <TabsList className="grid w-full max-w-md grid-cols-2">
                <TabsTrigger value="filtered" className="data-[state=active]:bg-primary">
                  <div className="flex items-center">
                    Gist Engine Filtered Content <Badge className="ml-2 bg-primary">7</Badge>
                  </div>
                </TabsTrigger>
          ...
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <Button variant="outline" className="flex items-center gap-2">
              ...
              Gist Engine Summary Preferences
            </Button>
            <Button variant="outline" className="flex items-center gap-2">
              Newsletter Filter
            ...
            <div className="border-b dark:border-slate-700 p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-bold dark:text-white">Daily Gist Engine Meta-Analysis</h2>
